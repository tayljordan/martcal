...
at sea to a port, accounting for land masses. The outcome uses a grid and to derive a trigonometric solution. The application is not quality tested 
and may be unsuitable for commercial use.
